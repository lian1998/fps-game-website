...
import { lep, _bpointsEvent } from "@src/viewlayers/LayerEventPipe";
...
export class BulletHoleFlashLayer implements CycleInterface, LoopInterface {
    ...
    name: string = 'bullethole flash layer';
    ...
    init(): void {
        ...
        const bulletHoles = new THREE.Points(this.bulletHoleGeometry, this.bulletHoleMaterial);
        ...
        this.normalBufferAttribute = new THREE.BufferAttribute(this.normalFoat32Array, 3);
        ...
        lep.addEventListener(_bpointsEvent.type, (e: CustomEvent) => {
