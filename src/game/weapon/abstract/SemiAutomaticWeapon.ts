...
import { iep, InputEventTYPE } from '@src/game/input/InputEventPipe';
...
export abstract class SemiAutomaticWeapon implements WeaponInterface {
    ...
    init() {
        ...
        // 监听键盘获取的武器事件
        iep.addEventListener('input', (e: CustomEvent) => {
            ...
            if (_weaponAnimEvent.detail.weaponUUID === this.weaponUUID) {
                ...
                switch (e.detail.type) {
                    case InputEventTYPE.BUTTON_RELOAD: // 换弹按键
                        ...
                        wep.dispatchEvent(_weaponAnimEvent); // 触发武器换弹事件

                        break;

                    case InputEventTYPE.BUTTON_TRIGGLE_DOWN: // 扣扳机
